<template>
    ...
    <div class="slider__box">
      ...
      <div class="slider__controls">
        <button @click="prevSlide" class="slider__button prev">Previous</button>
        <button @click="nextSlide" class="slider__button next">Next</button>
      </div>
    </div>
</div>
  </template>
  ...
  export default defineComponent({
    ...
    data() {
      return {
        currentIndex: 0,
        items: [
          { image: 'https://www.atorus.ru/sites/default/files/styles/head_carousel/public/2022-02/533e52.jpg.webp?itok=raXt4I0y' },
