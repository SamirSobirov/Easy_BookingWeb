        ...
        <div class="header__container">
            ...
            <nav class="header__nav">
                    ...
                    <div :class="['modal', { visible: isModalVisible }]">
                        <div class="modal-content">
                            <p>
                                ...
                                короткому номеру <a href="tel:1240">1240</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="language-selector">
                    <button class="header__nav-button header__nav-button--language" @click="toggleDropdown">
                    ...
                    <div v-if="isDropdownOpen" class="dropdown-menu">
                        ...
                        <div v-if="currentSection === 'language'">
                            ...
                            >
                                ...
                                <input type="radio" :checked="selectedLanguage.code === language.code"
                                       :name="'language'"/>
                            </div>
                        </div>
                        ...
                        <div v-if="currentSection === 'currency'">
                            ...
                            >
                                ...
                                <input type="radio" :checked="selectedCurrency.code === currency.code"
                                       :name="'currency'"/>
                            </div>
                        </div>
                    </div>
...
const handleWindowClick = (event: MouseEvent) => {
    ...
    if (!target.closest(".tel_modal-container") && !target.closest(".header__nav-phone") && isModalVisible.value) {
        toggleModal();
    }

    if (!target.closest(".dropdown-menu") && !target.closest(".header__nav-button--language") && isDropdownOpen.value) {
        closeDropdown();
    }
};
