        ...
        <div class="advantages__header">
            ...
            <div class="cards">
                <div>
                    ...
                    <span>Поиск и бронирование авиабилетов без лишних хлопот и ожиданий</span>
                </div>
                <div>
                ...
                <div class="person_img">
                    ...
                    <img src="/src/assets/images/person (2).svg" alt=""/>
                </div>
                <div>
                    <img src="/src/assets/images/baloon.svg" alt=""/>
                    <p>Легко и беззаботно</p>
                    <span>Вы платите ту цену, которую видите на экране. Можно спокойно готовиться к поездке</span>
                </div>
                <div>
                    <img src="/src/assets/images/crown.svg" alt=""/>
                    <p>Планируйте уверенно</p>
                    <span>Выгодные предложения, онлайн-страхованние, календарь и карта низкихцен</span>
                </div>
            </div>
        </div>
    </div>
